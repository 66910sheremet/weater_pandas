...
data = pd.read_excel(r"C:\Users\Eugene\Downloads\data1.xls")                                                             # ткрываем файл на чтение
T2005_2022 = data[["data","T"]]                                                                                          # забираем 2 колонки с датой и температурой
test2005_2022 = T2005_2022                                                                                               # gока что тестировочный файлик
...
T_meanday = test2005_2022.groupby("data").agg({"T":"mean"})                                                              # считам среднюю температуру по дням / автоматическая сортировка по дате с ранней
print(test2005_2022.head())
print(T_meanday.head(50))
...
total_cols = len(T_meanday)                                                                                              # фактическое колическо дней с данными по температуре
